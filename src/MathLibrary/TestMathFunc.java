...
public class TestMathFunc {
		...
		{ 
			...
			System.out.println("|" + j + "| is " + Math.abs(j)); //9
			System.out.println("|" + y + "| is " + Math.abs(y)); //0.34
//
...
//
			...
			System.out.println("FloorDiv of 9 & 4 is:" +Math.floorDiv(9,4)); //return quotient
			System.out.println("FloorDiv of8 & 4 is:" +Math.floorDiv(8,4));
			System.out.println("FloorDiv of 9 & 6is:" +Math.floorDiv(9,6));
			System.out.println("FloorDiv of 9 & 4 is:" +Math.floorMod(9,6));
			System.out.println("signum of -9 is : " +Math.signum(-9));
			System.out.println("signum of 9 is : " +Math.signum(9));
			System.out.println("nextAfter of 9.0 &9.5 is: " + Math.nextAfter(9.0, 9.5));
			System.out.println("nextDown of 9.0  is: " + Math.nextDown(9.0));
			System.out.println("nextUp of 9.0 is: " + Math.nextUp(9.0));
